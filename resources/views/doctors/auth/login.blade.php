...
@section('title', 'Doctor Login - Smart Hospital')
@section('description', 'Login untuk Dokter')
...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">Masuk ke sistem dokter</p>
        </div>

        <!-- Login Form -->
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form method="POST" action="{{ route('doctors.login.submit') }}" class="space-y-6">
                @csrf
                
                <div>
                    <label for="login" class="block text-sm font-medium text-gray-700 mb-2">
                        Email / Nomor Dokter / Nomor Dokter
                    </label>
        ...
        <div class="text-center space-y-4">
            ...
            <div class="flex justify-center space-x-4">
                <a href="{{ route('admins.login') }}" class="text-sm text-gray-500 hover:text-gray-700">
                    Login Admin
                </a>
